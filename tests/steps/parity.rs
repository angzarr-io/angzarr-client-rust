...
mod compile_probe {
    ...
    use angzarr_client::{
        ...
        upcaster, upcasts, uuid_for, uuid_obj_for, uuid_str_for, BuildError, ClientError,
        CommandBuilder, CommandHandlerClient, CommandHandlerGrpc, CommandHandlerRouter,
        CommandRejectedError, CompensationContext, Destinations, DispatchError, DomainClient,
        ExponentialBackoffRetry, ProcessManagerGrpc, ProcessManagerResponse, ProcessManagerRouter,
        ProjectorGrpc, ProjectorRouter, QueryBuilder, QueryClient, RejectionHandlerResponse,
        RetryPolicy, Router, SagaGrpc, SagaHandlerResponse, SagaRouter, ScenarioContext,
        SpeculativeClient, UpcasterGrpc, UpcasterRouter, DEFAULT_EDITION, DEFAULT_TEST_NAMESPACE,
